...
| :--- | :--- | :--- | :--- |
| eth | [BeaconChain](https://github.com/atif-konasl/eth-research/orchestratorapi/blob/master/eth/v1alpha1/beacon_chain.proto#L36) | v1alpha1 | This service is used to retrieve critical data relevant to the Ethereum 2.0 phase 0 beacon chain, including the most recent head block, current pending deposits, the chain state and more. |
| eth | [Node](https://github.com/atif-konasl/eth-research/orchestratorapi/blob/master/eth/v1alpha1/node.proto#L33) | v1alpha1 | The Node service returns information about the Ethereum node itself, including versioning and general information as well as network sync status and a list of services currently implemented on the node. |
| eth | [Validator](https://github.com/atif-konasl/eth-research/orchestratorapi/blob/master/eth/v1alpha1/validator.proto) | v1alpha1 | This API provides the information a validator needs to retrieve throughout its life cycle, including recieved assignments from the network, its current index in the state as well as the rewards and penalties that have been applied to it. |

## Contributing

Thanks for wanting to contribute to our eth2 API! Go libraries may be generated from the [ethereumapis repository](https://github.com/atif-konasl/eth-research/orchestratorapi) using [Bazel](https://bazel.build), making it easy to make changes to the schemas needed and generate Go files from them. Here's what you need to get started:
...
Then, open a pull request with your changes on https://github.com/atif-konasl/eth-research/orchestratorapi. Next, you'll be ready to implement your new changes in Prysm itself.
...
```bash
$ bazel run //:gazelle -- update-repos github.com/atif-konasl/eth-research/orchestratorapi
```
...
## License
[Apache 2.0](https://github.com/atif-konasl/eth-research/orchestratorapi/blob/master/LICENSE)
